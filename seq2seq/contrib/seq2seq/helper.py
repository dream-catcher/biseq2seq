...
class TrainingHelper(Helper):
  ...
  def __init__(self, inputs, sequence_length, time_major=False, name=None):
    ...
    with ops.name_scope(name, "TrainingHelper", [inputs, sequence_length]):
      print("TrainingHelper inputs:{} sequence_length:{}".format(inputs, sequence_length))
  ...
  def initialize(self, name=None):
    with ops.name_scope(name, "TrainingHelperInitialize"):
      ...
      print("TrainningHelper->initialize finished:{}".format(finished))
      print("self._input_tas:{}".format(self._input_tas))
      all_finished = math_ops.reduce_all(finished)
      next_inputs = control_flow_ops.cond(
          all_finished, lambda: self._zero_inputs,
          lambda: nest.map_structure(lambda inp: inp.read(0), self._input_tas))
      print("TrainingHelper->initialize finished:{} next_inputs:{}".format(finished, next_inputs))
      return (finished, next_inputs)
