...
tf.flags.DEFINE_string("export_dir", "fin_biseq2seq_model", "directory to load model from")
...
def main(_argv):
  ...
  with tf.Session() as sess:
    print("start to restore checkpoint:{} into session".format(checkpoint_path))
    saver.restore(sess, checkpoint_path)
